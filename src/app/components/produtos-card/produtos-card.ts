...
import { ProdutosService, OrdemProduto, SituacaoProduto } from '../../services/produtos.service';
...
export class ProdutosCard implements OnInit {
  ...
  // Remover é definitivo (o garimpo pode trazer de volta se a oferta voltar a
  // aparecer), então confirma antes — é a única ação destrutiva da tela.
